...
//2393dbfeb5054fff6edfc7607094b4bc        ccf345475c90dddd964a988ab2f6d087        2500000 2016-11-01 13:50:10.0
    ...
    //保存数据
    gV2.vertices.map(vp => vp._1.toString() + "\t" + vp._2.toString()).saveAsTextFile("xrli/POC/scc_10_vertices")
    gV2.edges.map(ep => ep.srcId.toString() + "\t" + ep.dstId.toString() + "\t" + ep.attr.toString()).saveAsTextFile("xrli/POC/scc_10_edges")
